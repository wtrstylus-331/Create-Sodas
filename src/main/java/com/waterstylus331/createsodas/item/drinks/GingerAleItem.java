...
public class GingerAleItem extends HoneyBottleItem {
    ...
    public ItemStack finishUsingItem(ItemStack itemStack, Level level, LivingEntity livingEntity) {
        ...
        if (livingEntity instanceof Player player) {
            ...
            if (!player.getAbilities().instabuild) {
                ...
                if (itemStack.isEmpty()) {
                    return new ItemStack(ModItems.EMPTY_GINGER_ALE.get());
                } else {
                    ItemStack emptyCan = new ItemStack(ModItems.EMPTY_GINGER_ALE.get());
        ...
        return itemStack.isEmpty() ? new ItemStack(ModItems.EMPTY_GINGER_ALE.get()) : itemStack;
    }
}
